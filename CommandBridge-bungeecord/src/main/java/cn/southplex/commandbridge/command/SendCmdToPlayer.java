...
public class SendCmdToPlayer extends Command {
    public SendCmdToPlayer() {
        super("sendcmdtoplayer","","sendcmdbc","sendcmdbungee");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if(ServerStatus.getRunningMode() == RunningMode.MESSAGE_QUEUE) {
            ...
            CommandBridgeBungee.getRunningModeItem().onCmd(args[0],out);
        } else {
